# Homebrew WAVEIX Packages

Homebrew formulae that allows installation of WAVEIX packages through the [Homebrew](https://brew.sh/) package manager.

## Usage

```shell
brew tap waveix/pkg
brew install waveix/pkg/<name>
```
